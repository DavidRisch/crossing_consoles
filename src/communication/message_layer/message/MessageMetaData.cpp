...
std::optional<std::chrono::steady_clock::time_point> MessageMetaData::GetTimestampSent() const {
  return timestamp_sent;
}
std::optional<std::chrono::steady_clock::time_point> MessageMetaData::GetTimestampReceived() const {
