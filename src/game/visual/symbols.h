...
const wchar_t box_drawings_light_vertical_and_right = L'\u251C';
const wchar_t box_drawings_light_vertical_and_left = L'\u2524';
const wchar_t box_drawings_light_horizontal_and_down = L'\u252C';
const wchar_t box_drawings_light_horizontal_and_up = L'\u2534';
...
// rendered as an extra wide character
const wchar_t black_heart_suit = L'\u2665';
const wchar_t black_diamond_suite = L'\u2666';
