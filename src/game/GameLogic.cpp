...
void GameLogic::MovePlayer(const std::shared_ptr<Player> &player, const coordinate_distance_t &movement,
...
void GameLogic::HandleChange(const std::shared_ptr<Player> &player, const Change &change,
                             const std::shared_ptr<world::World> &world) {
